...
class DatasetQueryAssistant:
    ...
    def generate_response(self, query, context):
        """Generate enhanced response using TinyLlama"""
        try:
            # Prepare prompt
    ...
    def perform_basic_eda(self, df, query):
        ...
        try:
            ...
            if "basic statistical" in query_lower or "basic stats" in query_lower:
            ...
            if "distribution" in query_lower and "histogram" in query_lower:
    ...
    def perform_time_series_analysis(self, df, query):
        ...
        try:
            query_lower = query.lower()
            if ("time series" in query_lower or "trend" in query_lower or 
            "hourly" in query_lower or "daily" in query_lower or 
            "monthly" in query_lower or "yearly" in query_lower or
            "weekday" in query_lower or "weekend" in query_lower or
            "first half" in query_lower or "second half" in query_lower or
            "compare halves" in query_lower):
                ...
                if "first half" in query_lower and "second half" in query_lower or "compare halves" in query_lower:
                ...
                if "hourly" in query_lower or "hour" in query_lower:
    ...
    def run(self):
        ...
        try:
            st.sidebar.info("""
            📊 This application uses TinyLlama for advanced data analysis.
